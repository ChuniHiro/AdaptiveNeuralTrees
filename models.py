...
class Solver_GAP_OneFClayers_class100(nn.Module):
    """ GAP + fc1 """
    def __init__(self, input_nc, input_width, input_height, 
                 dropout_prob=0.0, reduction_rate=2, **kwargs):
        super(Solver_GAP_OneFClayers_class100, self).__init__()
        self.dropout_prob = dropout_prob
        self.reduction_rate = reduction_rate

        self.fc1 = nn.Linear(input_nc, 100)
        self.sigmoid = nn.Sigmoid()
...
class Solver_GAP_OneFClayers_class200(nn.Module):
    """ GAP + fc1 """
    def __init__(self, input_nc, input_width, input_height, 
                 dropout_prob=0.0, reduction_rate=2, **kwargs):
        super(Solver_GAP_OneFClayers_class200, self).__init__()
        self.dropout_prob = dropout_prob
        self.reduction_rate = reduction_rate

        self.fc1 = nn.Linear(input_nc, 200)
        self.sigmoid = nn.Sigmoid()
